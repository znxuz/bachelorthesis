...
Für den Fall einer Senke mit einem einzigen Verbraucher genügt es, den Zustand
als \mintinline{cpp}|bool| zu speichern. Dieser gibt an, ob die Daten an einer
...
\mintinline{cpp}|HAL_UART_TxCpltCallback()| definiert werden, das nach jeder
...
Makro \mintinline{cpp}|traceTASK_SWITCHED_IN()| wird aufgerufen, unmittelbar
