...
vom Datenaustausch. Bei Micro-ROS werden die Daten in einer dedizierten Struktur
mit Metadaten -- unter anderem einem Header mit Zeitstempel in Sekunden und
Nanosekunden -- übertragen, was einen wesentlichen Overhead im Vergleich zu
FreeRTOS verursacht. Dort werden die Daten direkt als einfache, array-ähnliche
Struktur in die Warteschlange kopiert und extrahiert.
...
Overheads vom Drehzahlregler entkoppelt -- im Gegensatz zur straff gekoppelten
