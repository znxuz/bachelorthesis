...
Ein Benchmark für die Senke wurde entwickelt, um deren Leistung und
Zuverlässigkeit unter paralleler Last zu testen. Der Benchmark lässt eine Anzahl
von \mintinline{text}|BENCHMARK_N = 4| Tasks parallel laufen, die jeweils eine
Anzahl von \mintinline{cpp}|iteration = 5000| Nachrichten hintereinander über
...
der Funktion \mintinline{cpp}|vTaskGetRunTimeStats()| aus FreeRTOS ausgegeben.
...
Tmr Svc         0               <1%
    \end{minted}
        \captionof{listing}{Benchmark IO-gebunden}
    \end{code}
\end{minipage}
